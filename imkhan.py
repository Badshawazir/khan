...
88  dP 88  88    db    88b 88 
88odP  88  88   dPYb   88Yb88 
88"Yb  888888  dP__Yb  88 Y88 
88  Yb 88  88 dP""""Yb 88  Y8 
                                    
                                    
\033[0;37m
╔═══════════════════════════════════════╗ \033[0;37m
║[•] Author   : Rizwan && mylove        
║[•] Status   : Premium                 ║
║[•] Network  : 3G,4G/5G ON             ║
║[•] Version  : 1.0.7                   ║
...
def login_c():
	try:
		...
		print('%s[%s✔%s]%s Login successful run again \033[1;97m\033[1;41m python i4m_rasha.py \033[0m\033[1;93m'%(N,H,N,H));time.sleep(1)
		exit()
	except Exception as e:
